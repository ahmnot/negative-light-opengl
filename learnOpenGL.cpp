...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightAndLampPosition.y = sin(angle) * cos(angle)*2;
        lightAndLampPosition.z = cos(angle) * orbitRadius;
        ...
        lightingShader.setVec3("lightProperties.diffuse", lightColor * 1.0f);
